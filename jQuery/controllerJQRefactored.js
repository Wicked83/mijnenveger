...
$(function () {
    ...
    /* var bommen = $('#invoerBommen').val();
    var rijen = $('#invoerRijen').val();
    var kolommen = $('#invoerKolommen').val(); */

    var start = $("#btnStart");

    start.on('click', function () {
        if ($('#invoerBommen').val() < 1 || $('#invoerRijen').val() * $('#invoerKolommen').val()
...
function bouwVeld() {
    var aantalKolommen = +$("#invoerKolommen").val(),
        aantalBommen = +$("#invoerBommen").val(),
        aantalRijen = +$("#invoerRijen").val();
    for (var i = 0; i < aantalRijen; i++) {
        $('#divSpelbord').append($('<tr>').attr('id', i));
